...
The codes are checked and ready to be made public.
...
In the long-term forecasting experiments of our paper, we reported the average performance of APTF on future time steps of 96, 192, 336, and 720 (as shown in the table below, corresponding to Table 2 in the original paper). We have provided the experimental scripts and corresponding hyperparameters to reproduce these results.

<img src="Figure/TSF_Long_term.jpg" alt="替代文本" width="auto" height="170">
